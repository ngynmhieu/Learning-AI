...
import { useCollectToLibrary, useDiscardFromLibrary } from "../features";
...
export function LibraryPage() {
  ...
  // progressive update from useCollectToLibrary replaces just that trailing
          ...
          {mode === "scrape" ? (
            <ScrapePicker
              ...
              onImport={async (urls, referer) => {
                ...
                await importUrlsToLibrary(urls, referer, (resolvedSoFar) => {
